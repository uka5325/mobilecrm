              ...
              {activeTab === "info" && (
                <>
                  ...
                  <div className="mt-5 border-t border-[#edf0f3] pt-4">
                    ...
                    <button className="mt-2 w-full rounded-xl bg-emerald-600 py-2 text-sm font-medium text-white transition hover:-translate-y-0.5 hover:shadow-md active:scale-95">
                      메모 추가
                    </button>
                  </div>
                </>
