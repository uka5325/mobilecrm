    ...
    <aside className="hidden min-h-screen w-[220px] shrink-0 flex-col justify-between bg-[rgb(6,44,49)] px-5 py-5 lg:flex">
      <div>
        <div className="mb-7">
          ...
          <p className="mt-1 text-xs leading-5 text-[rgba(255,255,255,0.55)]">
            예약, 고객관리, 정산을
            <br />
            한곳에서 관리합니다.
          </p>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={
                  active
                    ? "flex items-center rounded-xl bg-white px-3 py-2.5 text-sm font-semibold !text-[#062c31]"
                    : "flex items-center rounded-xl px-3 py-2.5 text-sm font-semibold !text-[rgba(255,255,255,0.72)] transition hover:bg-[rgba(255,255,255,0.06)] hover:!text-white"
                }
              >
