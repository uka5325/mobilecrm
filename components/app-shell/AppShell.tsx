    ...
    <div className="min-h-screen bg-[#f6f7f5] text-[#12151f] lg:flex">
      ...
      <main className="min-w-0 flex-1 px-4 pb-28 pt-5 sm:px-6 lg:px-8 lg:py-8">
        <div className="mx-auto w-full max-w-[1320px]">
          <div className="pointer-events-none fixed inset-x-0 top-0 z-30 h-[calc(env(safe-area-inset-top)+12px)] bg-[#f6f7f5]/70 backdrop-blur-lg backdrop-saturate-150 lg:left-[272px] lg:h-8" />
