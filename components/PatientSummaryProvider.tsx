...
function mapPatientDocument(doc: QueryDocumentSnapshot<DocumentData>): PatientRecord {
  ...
  return {
    ...
    settlementCount: numberOrUndefined(data.settlementCount),
    totalSettlementPaid: numberOrUndefined(data.totalSettlementPaid),
    totalSettlementRefunded: numberOrUndefined(data.totalSettlementRefunded),
    netSettlementAmount: numberOrUndefined(data.netSettlementAmount),
