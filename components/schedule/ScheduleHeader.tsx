  ...
  return (
    <section className="rounded-[26px] bg-[#eaf8f3] p-4 shadow-[0_10px_24px_rgba(15,23,42,0.05)] lg:p-5">
      ...
      <div className="mt-1.5">
        ...
        >
          <span className="text-xs font-semibold text-[#101828]">오늘의 메모</span>
        ...
        {memoSectionOpen ? (
          <div className="mt-0.5">
            {todayMemos.length === 0 ? (
              <p className="text-[11px] font-normal text-[#667085]">오늘 등록된 메모가 없습니다.</p>
            ) : (
              <div className="flex gap-2 overflow-x-auto pb-1">
                {todayMemos.map((memo) => (
                  <div key={memo.id} className="min-w-[160px] max-w-[240px] shrink-0 rounded-[18px] bg-white/72 px-3 py-2 text-xs">
