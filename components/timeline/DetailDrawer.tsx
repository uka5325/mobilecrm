...
export function DetailDrawer({ open, reservation, currentUser, onClose, onRefreshLatestLog, onRefresh }: Props) {
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-[998] flex items-start justify-center overflow-y-auto bg-black/35 px-3 py-4 backdrop-blur-[2px] sm:items-center sm:p-6"
        onClick={onClose}
      >
        <div
          className="flex h-[calc(100vh-32px)] w-full max-w-[720px] flex-col overflow-hidden rounded-[32px] bg-white shadow-[0_28px_90px_rgba(15,23,42,0.26)] sm:h-[min(820px,calc(100vh-48px))]"
